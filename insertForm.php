...
<html>
	...
	<center>
		<form method="post" action="insertPro.php">
			<tr><td><b>회원가입</b></td></tr>
			<table border="1">
				<tr>
					<td><b>ID</b></td>
					<td><input type="text" name="id" size="20" placeholder="oooooo" required onfocus></td>
				</tr>

				<tr>
					<td><b>PASSWORD</b></td>
					<td><input type="password" name="pw" size="20" placeholder="8~20글자" required></td>
				</tr>
				...
				<tr>
					<td><b>학과</b></td>
					<td><input type="text" name="dept_id" size="20" placeholder="ooo학과" required></td>
				</tr>

				<tr>
					<td><b>학번</b></td>
					<td><input type="text" name="std_id" size="20" placeholder="1~10글자" required></td>
				</tr>

				<tr>
					<td><b>전화번호</b></td>
					<td><input type="text" name="phone" size="20" placeholder="'-'없이 입력" required></td>
				</tr>

				<tr>
					<td><b>E-mail</b></td>
					<td><input type="text" name="email" size="20" placeholder="ooo@naver.com" required></td>
				</tr>

				<tr>
					<td><b>기수</b></td>
					<td><input type="text" name="period" size="20" placeholder="o기" required></td>
				</tr>
