...
<html>
	...
	?>
	<center>
		<form method="get" action="login_result.php">
			<tr><td><b>로그인</b></td></tr>
			<table border="1">
				<tr><td><input type="text" name="userid" placeholder="ID" required autofocus><br></td></tr>
				<tr><td><input type="password" name="pw" placeholder="PASSWORD" required><br></td></tr>
